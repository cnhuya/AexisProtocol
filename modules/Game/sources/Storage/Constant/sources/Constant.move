module deployer::testConstantV1{
...
// Structs
    ...
    struct Constant has copy,store,drop,key {header: String, name: String, value: u256}
...
// Entry Functions
    public entry fun registerConstant(address: &signer, header: String, constant_name: String, value: u256) acquires ConstantDatabase {
    ...
    public entry fun change_constant(address: &signer, header: String, name: String, new_value: u256) acquires ConstantDatabase {
...
// Util Functions
    // Make
        fun make_constant(header: String, name: String, value: u256): Constant {
            Constant { header: header, name: name, value: value }
        }
